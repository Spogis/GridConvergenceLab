    ...
    layout = html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.Div(id='output-image-upload-1-rgb', style={'textAlign': 'center', 'marginTop': '10px'})
            ...
            html.Div([
                ...
                html.Div(id='output-image-upload-2-rgb', style={'textAlign': 'center', 'marginTop': '10px'})
            ], style={'width': '48%', 'display': 'inline-block', 'verticalAlign': 'top'}),
