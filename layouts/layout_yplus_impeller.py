            ...
            html.Div([
                html.Div([
                    html.Div([
                        ...
                        dcc.Input(id='input-density-impeller', type='number', min=0, value=1000,
                    ...
                    html.Div([
                        ...
                        dcc.Input(id='input-viscosity-impeller', type='number', min=0, value=0.001,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingRight': '10px'}),

                    html.Div([
                        html.Label('Impeller Velocity (RPM):'),
                        dcc.Input(id='input-rpm-impeller', type='number', min=0, value=360,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingRight': '10px'}),
                ...
                html.Div([
                    html.Div([
                        html.Label('Impeller_Diameter (m):'),
                        dcc.Input(id='input-diameter-impeller', type='number', min=0, value=1,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingLeft': '10px'}),

                    html.Div([
                        html.Label('Desired Yplus:'),
                        dcc.Input(id='input-yplus-impeller', type='number', min=0, value=1,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingLeft': '10px'}),

                    html.Div([
                        html.Label('Growth Rate:'),
                        dcc.Input(id='input-growth-rate-impeller', type='number', min=1, value=1.2,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingLeft': '10px'}),
                ], style={'flex': '1', 'display': 'flex', 'flexDirection': 'column', 'alignItems': 'center',
                          'width': '100%'}),
            ...
            html.Div([
                html.Div([
                    html.Div([
                        ...
                        dcc.Input(id='output-reynolds-impeller', type='text', disabled=True,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center',
                    ...
                    html.Div([
                        ...
                        dcc.Input(id='output-boundary-layer-thickness-impeller', type='text', disabled=True,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center',
                                         'backgroundColor': '#ECF0F1'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingRight': '10px'}),
                ], style={'flex': '1', 'display': 'flex', 'flexDirection': 'column', 'alignItems': 'center',
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Input(id='output-first-layer-thickness-impeller', type='text', disabled=True,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center',
                                         'backgroundColor': '#ECF0F1'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingLeft': '10px'}),
                    ...
                    html.Div([
                        ...
                        dcc.Input(id='output-number-of-layers-impeller', type='text', disabled=True,
                                  style={'width': '100%', 'padding': '10px', 'textAlign': 'center',
                                         'backgroundColor': '#ECF0F1'}),
                    ], style={'marginBottom': '20px', 'width': '100%', 'paddingLeft': '10px'}),
                ], style={'flex': '1', 'display': 'flex', 'flexDirection': 'column', 'alignItems': 'center',
